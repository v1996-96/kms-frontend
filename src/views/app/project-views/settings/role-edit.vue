...
import Api from '@/api'
import RoleModel from '@/models/project-role'
import PermissionsList from '@/components/active/project-permissions-list'
...
export default {
  ...
  methods: {
    ...
    fetch () {
      ...
      Api.projects.getRole({ id: this.roleId }).then((response) => {
